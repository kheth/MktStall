...
public class SeedRunner extends SwingWorker<String,String> {
    ...
    public SeedRunner(Settings settings, ActionListener listener, JTextArea userInfo, ProcessPDFS pdfs, boolean all){
    ...
    public void doAll() throws IOException, InterruptedException{
        this.userInfo.append("Running seed analysis.\n");
        //RUN THE MKTSTALL SCRIPT
        ProcessBuilder builder = new ProcessBuilder(settings.getRUN_SEED_ANALYSIS_SCRIPT());
        System.out.println("Running script: "+settings.getRUN_SEED_ANALYSIS_SCRIPT());
        builder.directory(new File(settings.getMKTSTALL_PYTHON()));
        System.out.println("Builder directory: "+settings.getMKTSTALL_PYTHON());
    ...
    @Override
    protected void done(){
        this.listener.actionPerformed(new ActionEvent(this, 1, "SEED_DONE"));
