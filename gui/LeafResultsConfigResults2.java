...
public class LeafResultsConfigResults2
{
     ...
     */
    String filepathToConfig= "~/bitbucket_repos/mktstall/mktstall_py/results/summary_output.config_output.config";
        ...
        for(String c :configStrings){
            ...
            if (c.startsWith("#status_")){
                ...
                if(status[0].matches("initial_image")){
                    ...
                    if (status[1].matches("SUCCESS")){
                      status_html_summary_plot_leaf_teeth_path = true;
                    } else{
                      status_html_summary_plot_leaf_teeth_path = false;
                    }
                } else if(status[0].matches("html_summary_plot_leaf_shape2_path")){
                    if (status[1].matches("SUCCESS")){
                      status_html_summary_plot_leaf_shape2_path = true;
                    } else{
                      status_html_summary_plot_leaf_shape2_path= false;
                    }
                } else if(status[0].matches("html_summary_plot_leaf_compactness_path")){
                    if (status[1].matches("SUCCESS")){
                      status_html_summary_plot_leaf_compactness_path = true;
                    } else{
                      status_html_summary_plot_leaf_compactness_path= false;
                    }
                } else if(status[0].matches("html_summary_plot_leaf_eqd_cm_path")){
                    if (status[1].matches("SUCCESS")){
                      status_html_summary_plot_leaf_eqd_cm_path = true;
                    } else{
                      status_html_summary_plot_leaf_eqd_cm_path= false;
                    }
                } else if(status[0].matches("html_boxplot_pixels_path")){
                    if (status[1].matches("SUCCESS")){
                      status_html_boxplot_pixels_path = true;
                    } else{
                      status_html_boxplot_pixels_path= false;
                    }
                } else if(status[0].matches("html_boxplot_cm_path")){
                    if (status[1].matches("SUCCESS")){
                      status_html_boxplot_cm_path = true;
                    } else{
                      status_html_boxplot_cm_path= false;
                    }
                } else if(status[0].matches("html_pca_path")){
                    if (status[1].matches("SUCCESS")){
                      status_html_pca_path = true;
                    } else{
                      status_html_pca_path= false;
                    }
                }else {
            ...
            if (p.startsWith("#PATH=")){
                ...
                fileTokens = pathString[0].split("/");
                if(fileTokens[-1].endsWith(".cr.jpg")){
                    crop1_image = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg")){
                    rotate_image = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg")){
                    crop2_image = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpgdilated_skinny.jpg")){
                    dilated_skinny_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.contours.jpg")){
                    contours_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.contours_skinny.jpg")){
                    contours_skinny_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.centroid.jpg")){
                    centroid_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.centroid_skinny.jpg")){
                    centroid_skinny_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.length.jpg")){
                    length_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.width.jpg")){
                    width_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.area.jpg")){
                    area_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.aspectratio.jpg")){
                    aspect_ratio_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.roundness.jpg")){
                    roundness_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.compactness.jpg")){
                    compactness_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.rectangularity.jpg")){
                    rectangularity_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".jpg.ro.jpg.c2.jpg.perimeterratiolength.jpg")){
                    perimeterratiolength_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.perimeterratiolengthwidth.jpg")){
                    perimeterratiolengthwidth_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.perimeterconvexity.jpg")){
                    perimeterconvexity_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.areaconvexity.jpg")){
                    areaconvexity_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.arearatioconvexity.jpg")){
                    arearatioconvexity_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.arearatioconvexity.jpg")){
                    arearatioconvexity_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.equivalentdiameter.jpg")){
                    equivalentdiameter_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.centroid.jpg.area_teeth.jpg")){
                    area_teeth_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.centroid.jpg.area_teeth_2sd.jpg")){
                    area_teeth_2sd_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.centroid.jpg.area_teeth_2sd_sinusPointsLength.jpg")){
                    area_teeth_2sd_sinusPointsLength_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.centroid.jpg.area_teeth_2sd_sinusPointsLength_height.jpg")){
                    area_teeth_2sd_sinusPointsLength_height_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.centroid.jpg.area_teeth_2sd_sinusPointsLength_height_overlapsFiltered_apexF.jpg")){
                    area_teeth_2sd_sinusPointsLength_height_overlapsFiltered_apexF_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.centroid.jpg.area_teeth_2sd_sinusPointsLength_height_overlapsFiltered_lobeF.jpg")){
                    area_teeth_2sd_sinusPointsLength_height_overlapsFiltered_lobeF_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith(".cr.jpg.ro.jpg.c2.jpg.centroid.jpg.area_teeth_2sd_sinusPointsLength_height_overlapsFiltered_ID_key_a.jpg")){
                    area_teeth_2sd_sinusPointsLength_height_overlapsFiltered_ID_key_a_path = fileTokens[-1];
                }
                else if (fileTokens[-1].endsWith(".centroid.jpg.area_teeth_2sd_sinusPointsLength_height_overlapsFiltered.jpg")){
                    area_teeth_2sd_sinusPointsLength_height_overlapsFiltered_path = fileTokens[-1];
                }else if (fileTokens[-1].startsWith("html_shape_descriptors")){
                    html_shape_path = fileTokens[-1];
                }else if (fileTokens[-1].startsWith("html_morphological_descriptors")){
                    html_morphological_path = fileTokens[-1];
                }else if (fileTokens[-1].startsWith("html_morphological_descriptors")){
                    html_morphological_path = fileTokens[-1];
                }else if (fileTokens[-1].startsWith("html_leaf_margin_chart")){
                    html_margin_path = fileTokens[-1];
                }else if (fileTokens[-1].startsWith("html_method")){
                    html_method_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith("html_summary_table.html")){
                    html_summary_table_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith("html_summary_plot_pixels_morphological.html")){
                    html_plot_pixels_morphological_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith("html_summary_plot_pixels_eqs.html")){
                    html_plot_pixels_morphological_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith("html_summary_plot_leaf_morphological_cm.html")){
                    html_summary_plot_leaf_morphological_cm_output_config_file_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith("html_summary_plot_leaf_teeth.html")){
                    html_summary_plot_leaf_teeth_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith("html_summary_plot_leaf_shape.html")){
                    html_summary_plot_leaf_shape_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith("html_summary_plot_leaf_shape2.html")){
                    html_summary_plot_leaf_shape2_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith("html_summary_plot_leaf_compactness.html")){
                    html_summary_plot_leaf_compactness_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith("html_summary_plot_leaf_eqd_cm.html")){
                    html_summary_plot_leaf_eqd_cm_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith("html_boxplot_cm.html")){
                    html_boxplot_cm_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith("html_boxplot_pixels.html")){
                    html_boxplot_pixels_path = fileTokens[-1];
                }else if (fileTokens[-1].endsWith("pca.html")){
                    html_pca_path = fileTokens[-1]; 
                } else{
                    initial_image = fileTokens[-1];
                }
            }
        }
    }}
